...
public class ILRuntimeCrossBinding
{
   [MenuItem("ILRuntime/生成跨域继承适配器")]
    static void GenerateCrossbindAdapter()
    {
        ...
        using(System.IO.StreamWriter sw = new System.IO.StreamWriter("Assets/ILRuntimeShared/ILRuntimeAutoGen/DF_Wweening_Core_ABSAnimationComponentAdapter.cs"))
        {
		...
		using (System.IO.StreamWriter sw = new System.IO.StreamWriter("Assets/ILRuntimeShared/ILRuntimeAutoGen/System_EventArgsAdapter.cs")) {
		...
		using (System.IO.StreamWriter sw = new System.IO.StreamWriter("Assets/ILRuntimeShared/ILRuntimeAutoGen/AssemblyCommon_IShowDownloadProgress.cs")) {
		...
		using (System.IO.StreamWriter sw = new System.IO.StreamWriter("Assets/ILRuntimeShared/ILRuntimeAutoGen/CustomYieldInstructionAdapter.cs")) {
		...
		using (System.IO.StreamWriter sw = new System.IO.StreamWriter("Assets/ILRuntimeShared/ILRuntimeAutoGen/AssemblyCommon_ControllerBaseAdapter.cs")) {
		...
		using (System.IO.StreamWriter sw = new System.IO.StreamWriter("Assets/ILRuntimeShared/ILRuntimeAutoGen/System_IEquatable_ILTypeInstance.cs")) {
		...
		using (System.IO.StreamWriter sw = new System.IO.StreamWriter("Assets/ILRuntimeShared/ILRuntimeAutoGen/System_EqualityComparer_Double.cs")) {
		...
		using (System.IO.StreamWriter sw = new System.IO.StreamWriter("Assets/ILRuntimeShared/ILRuntimeAutoGen/System_EqualityComparer_Single.cs")) {
		...
		using (System.IO.StreamWriter sw = new System.IO.StreamWriter("Assets/ILRuntimeShared/ILRuntimeAutoGen/System_EqualityComparer_Null_Double.cs")) {
		...
		using (System.IO.StreamWriter sw = new System.IO.StreamWriter("Assets/ILRuntimeShared/ILRuntimeAutoGen/System_EqualityComparer_Null_Single.cs")) {
		...
		using (System.IO.StreamWriter sw = new System.IO.StreamWriter("Assets/ILRuntimeShared/ILRuntimeAutoGen/System_IComparable_ILTypeInstance.cs")) {
		...
		using (System.IO.StreamWriter sw = new System.IO.StreamWriter("Assets/ILRuntimeShared/ILRuntimeAutoGen/IProtoMessage_Adapter.cs")) {
